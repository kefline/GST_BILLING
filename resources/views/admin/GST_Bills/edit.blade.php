                        ...
                        <form class="form-horizontal" method="post" action="{{ route('admin.GST_Bills.add') }}">
                            ...
                            <div class="box-body">
                                <div class="form-group mb-3 col-6 md-4">
                                    <label for="" class="col-sm-2 control-label">Add Parties Type Name <span
                                            ...
                                            <div class="col-sm-3">
                                                <select name="parties_types_id" class="form-control" placeholder="Enter parties type Name" required>
                                                    @foreach ($getpartiesType as $value)
                                                        <option value="{{ $value->id }}" {{ ($getrecords->parties_types_id == $value->id) ? 'selected' : '' }}>
                                                            {{ $value->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control" id="" name="invoice_date" value="{{$getrecords->invoice_date}}"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="form-group mb-3 col-6 md-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="" name="invoice_no" value="{{$getrecords->invoice_no}}"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description" value="{{$getrecords->description}}"
                            ...
                            <div class="box-body">
                                <div class="form-group  mb-3 col-6 md-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="total_amount" value="{{$getrecords->total_amount}}"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="cgst_rate" value="{{$getrecords->cgst_rate}}"
                            ...
                            <div class="box-body">
                                <div class="form-group mb-3 col-6 md-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="sgst_rate" value="{{$getrecords->sgst_rate}}"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="igst_rate" value="{{$getrecords->igst_rate}}"
                            ...
                            <div class="box-body">
                                <div class="form-group mb-3 col-6 md-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="cgst_amount" value="{{$getrecords->cgst_amount}}"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="sgst_amount" value="{{$getrecords->sgst_amount}}"
                            ...
                            <div class="box-body">
                                <div class="form-group mb-3 col-6 md-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="igst_amount" value="{{$getrecords->igst_amount}}"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="tax_amount" value="{{$getrecords->tax_amount}}"
                            ...
                            <div class="box-body">
                                <div class="form-group mb-3 col-6 md-4">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control" id="" name="net_amount" value="{{$getrecords->net_amount}}"
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <textarea class="form-control" id="" rows="3" name="declaration" value="{{$getrecords->declaration}}" placeholder="Declaration" required></textarea>
                                    </div>
                                </div>
                            </div>
